...
import com.pku.apidiff.Change;
import com.pku.apidiff.enums.Category;
import com.pku.apidiff.enums.ElementType;
import com.pku.apidiff.internal.analysis.description.MethodDescription;
...
public class MethodDiff {
	...
	private String getSimpleNameMethod(MethodDeclaration methodVersion){
		String nameMethod = "";
		if(methodVersion != null){
			String returnType = (methodVersion.getReturnType2() != null && methodVersion.getReturnType2().resolveBinding() != null) ? methodVersion.getReturnType2().resolveBinding().getQualifiedName() : "";
			String parametersMethod = (methodVersion.parameters() != null) ? StringUtils.join(methodVersion.parameters(), ", ") : " ";
			nameMethod = returnType +" "+ methodVersion.getName() + "(" + parametersMethod + ")";
		}
		return nameMethod;
	}
